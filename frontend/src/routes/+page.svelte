<script lang="ts">
  ...
  onMount(async () => {
    const players = await axios.get('/backend/players');
...
<div class="flex h-screen bg-gray-200 font-roboto">
    <div class="block fixed inset-0 z-20 transition-opacity bg-black opacity-50 lg:hidden"></div>
    
<div class="translate-x-0 ease-out fixed inset-y-0 left-0 z-30 w-64 overflow-y-auto transition duration-300 transform bg-gray-900 lg:translate-x-0 lg:static lg:inset-0">
